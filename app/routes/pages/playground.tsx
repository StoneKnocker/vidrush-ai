...
export default function PlaygroundRoute({ loaderData }: Route.ComponentProps) {
  ...
  return (
    <main className="relative min-h-[calc(100vh-4rem)] overflow-hidden bg-[#050507]">
      ...
      <div className="relative mx-auto flex w-full max-w-7xl flex-col items-center gap-8 px-4 py-16 sm:px-6 lg:px-8">
        <section className="mx-auto max-w-3xl text-center">
          <h1 className="text-balance font-display font-normal text-4xl text-[#f2f2f2] tracking-[-0.02em] sm:text-5xl">
            {content.title}
          </h1>
          <p className="mt-4 text-balance text-[#b8b3b0] text-lg leading-8">
            {content.description}
          </p>
        </section>
