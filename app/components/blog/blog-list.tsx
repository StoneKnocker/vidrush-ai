...
function BlogCard({
  ...
  return (
    <Link
      to={href}
      className="group hover:-translate-y-1 relative flex h-full flex-col overflow-hidden rounded-lg border border-[#3d3a39] bg-[#101010] shadow-[0_0_15px_rgba(92,88,85,0.16)] transition-all duration-300 hover:border-[#00d992]/70 hover:shadow-[0_0_24px_rgba(0,217,146,0.14)]"
    >
      ...
      <div className="flex flex-1 flex-col px-6 py-6">
        <p className="mb-3 font-medium text-[#00d992] text-[11px] uppercase tracking-[0.26em]">
          {articleEyebrow}
        </p>
        <h2 className="mb-3 text-balance font-semibold text-2xl text-[#f2f2f2] leading-tight">
          {post.title}
        </h2>
        <p className="mb-6 flex-1 text-[#b8b3b0] text-[15px] leading-7">
          {post.description}
        </p>
        <span className="inline-flex items-center gap-2 font-semibold text-[#00d992] text-sm transition-colors group-hover:text-[#2fd6a1]">
          {readMoreLabel}
