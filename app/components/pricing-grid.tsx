        ...
        <div className="mb-8 flex flex-wrap items-center justify-center gap-2">
          <button
            ...
            className={`flex min-h-11 items-center gap-2 rounded-md border px-6 py-3 font-semibold text-sm transition-all duration-300 ${
              mode === "subscription"
                ? "border-primary/70 bg-primary/12 text-foreground shadow-[0_0_24px_rgba(0,217,146,0.18)]"
          ...
          >
            <Zap
              size={16}
              className={
                mode === "subscription" ? "fill-primary text-primary" : ""
              }
            />
          ...
          >
            <Coins
              size={16}
              className={mode === "credits" ? "text-primary" : ""}
            />
      ...
      {mode === "subscription" && !compact && (
        <div className="mb-8 flex flex-wrap items-center justify-center gap-4">
          ...
          <button
            ...
            className={`relative h-8 w-16 rounded-full border p-1 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:ring-offset-2 focus:ring-offset-background ${
              isAnnual
                ? "border-primary/80 bg-primary/25 shadow-[0_0_18px_rgba(0,217,146,0.25)]"
                : "bg-card"
            }`}
            aria-pressed={isAnnual}
          >
            <div
              className={`size-6 transform rounded-full bg-foreground shadow-[0_0_12px_rgba(255,255,255,0.25)] transition-transform duration-300 ${
          ...
          <span className="relative rounded-md border border-primary/60 bg-card px-3 py-1.5 font-bold text-primary text-xs shadow-[0_0_18px_rgba(0,217,146,0.16)]">
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  "bg-card text-foreground shadow-[0_0_15px_rgba(92,88,85,0.14)]",
                  "hover:-translate-y-1 hover:border-primary/70 hover:shadow-[0_0_26px_rgba(0,217,146,0.14)]",
                  plan.enterprise ? "bg-card" : "",
                  plan.popular &&
                    "z-10 border-primary bg-[radial-gradient(circle_at_top,_rgba(0,217,146,0.14),_transparent_48%),#101010] shadow-[0_0_34px_rgba(0,217,146,0.2)]",
                )}
              >
                {/* Popular badge */}
                {plan.popular && (
                  <div className="-translate-x-1/2 -translate-y-1/2 absolute top-0 left-1/2 z-20 flex whitespace-nowrap rounded-md border border-primary/70 bg-primary px-4 py-1.5 font-bold text-primary-foreground text-xs shadow-[0_0_20px_rgba(0,217,146,0.25)]">
                ...
                <div className="mb-6">
                  ...
                  {!isCustom && isAnnual && (
                    <p className="mt-2 flex items-center gap-1 text-muted-foreground/70 text-xs">
                      <Clock size={12} />
                ...
                <div className="mb-6 flex-grow">
                  <ul className="space-y-3">
                    {plan.features.map((feature: string) => (
                      ...
                      >
                        <div className="mt-0.5 flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-md border border-primary/35 bg-primary/10 text-primary">
                ...
                <LoadingButton
                  className={`group/btn h-12 w-full font-semibold text-base transition-all duration-300 ${
                    plan.popular
                      ? "hover:-translate-y-0.5 border border-primary/70 bg-primary text-primary-foreground shadow-[0_0_24px_rgba(0,217,146,0.2)] hover:bg-primary/90 hover:text-primary-foreground"
                      : plan.enterprise
                        ? "border bg-background text-foreground hover:border-primary/60 hover:bg-card hover:text-primary"
                        : "border bg-background text-foreground hover:border-primary/60 hover:bg-card hover:text-primary"
                  }`}
          ...
          <div className={creditPackGridClasses}>
            {creditPacks.map((pack: CreditPack) => (
              <div
                key={pack.id}
                className={cn(
                  "group relative flex h-full flex-col overflow-visible rounded-lg border bg-card p-8 transition-all duration-300",
                  "hover:-translate-y-1 shadow-[0_0_15px_rgba(92,88,85,0.14)] hover:border-primary/70 hover:shadow-[0_0_26px_rgba(0,217,146,0.14)]",
                  pack.popular
                    ? "border-primary bg-[radial-gradient(circle_at_top,_rgba(0,217,146,0.14),_transparent_48%),#101010] shadow-[0_0_34px_rgba(0,217,146,0.2)]"
                    : "",
              ...
              >
                ...
                <div className={cn("mb-6 text-center", pack.popular && "pt-4")}>
                  ...
                  <div className="font-bold text-primary text-sm uppercase tracking-wide">
                ...
                <div className="mb-8 rounded-lg border bg-card p-5 text-center">
                  ...
                  <div className="font-medium text-muted-foreground/70 text-sm">
                    {pack.perCredit}
                  </div>
                </div>
                ...
                <ul className="mb-8 flex-grow space-y-4">
                  {pack.features.map((feature: string) => (
                    ...
                    >
                      <div className="flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-md border border-primary/35 bg-primary/10">
                        <Check
                          size={12}
                          strokeWidth={3}
