...
const footerLinkClass = cn(
  "group inline-flex w-fit items-center gap-1.5 rounded-md px-0 py-0 text-[#b8b3b0] text-sm transition-colors",
  "hover:text-[#00d992]",
  "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#00d992]/50 focus-visible:ring-offset-2 focus-visible:ring-offset-[#050507]",
);

const socialLinkClass = cn(
  "inline-flex size-10 items-center justify-center rounded-md border border-[#3d3a39] bg-[#101010] text-[#b8b3b0] shadow-[0_0_15px_rgba(92,88,85,0.16)] transition-all",
  "hover:-translate-y-0.5 hover:border-[#00d992]/70 hover:text-[#00d992]",
  "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#00d992]/50 focus-visible:ring-offset-2 focus-visible:ring-offset-[#050507]",
);

const languageSwitcherClass = cn(
  "flex items-center gap-1.5 rounded-md border border-[#3d3a39] bg-[#101010] px-3.5 py-2 text-[#b8b3b0] shadow-[0_0_15px_rgba(92,88,85,0.12)] backdrop-blur-sm transition-all",
  "hover:border-[#00d992]/70 hover:text-[#f2f2f2]",
  "focus-visible:border-[#00d992]/70 focus-visible:outline-none",
);
...
export default function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden border-[#3d3a39] border-t bg-[#050507]">
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div className="flex flex-col gap-14 lg:flex-row lg:items-start lg:justify-between">
          <div className="relative max-w-sm text-[#f2f2f2]">
            <div>
              <AppLogo />
              <p className="mt-5 max-w-xs text-pretty text-[#b8b3b0] text-sm leading-6">
            ...
            <div className="grid grid-cols-1 gap-10 sm:grid-cols-3 sm:gap-8 lg:gap-14">
              {navGroups.map((group) => (
                <div key={group.title} className="flex flex-col gap-5">
                  <p className="font-semibold text-[#8b949e] text-[0.8rem] uppercase tracking-[0.22em]">
                    {group.title}
                  </p>
        ...
        <div className="flex flex-col gap-6 pt-6 text-[#8b949e] text-sm sm:flex-row sm:items-start sm:justify-between sm:pt-10">
          <div className="">
                  ...
                  .map((badge) => (
                    ...
                    >
                      {badge.img ? (
                        ...
                        <span className="text-[#b8b3b0] text-sm transition duration-300 group-hover:text-[#00d992]">
                          {badge.title}
                        </span>
                      )}
                    </a>
          ...
          <div className="flex shrink-0 flex-col items-start gap-3 lg:items-end">
            <DropdownMenu>
              ...
              >
                <Globe className="size-4 text-[#8b949e]" />
              ...
              <DropdownMenuContent
                align="end"
                className="rounded-lg border-[#3d3a39] bg-[#101010]/95 p-1 text-[#f2f2f2] shadow-[0_20px_60px_rgba(0,0,0,0.7)] backdrop-blur-sm"
              >
                {languageLinks.map((language) => (
                  <DropdownMenuItem key={language} asChild>
                    <Link
                      to={localizedTarget}
                      locale={language}
                      className="block rounded-md px-3 py-2 text-[#b8b3b0] text-sm no-underline transition-colors hover:text-[#00d992] focus:bg-[#050507] focus:text-[#00d992]"
                    >
            ...
            <div className="flex flex-col gap-1 text-left lg:text-right">
              <p className="text-balance text-[#8b949e]">
