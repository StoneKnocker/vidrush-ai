  ...
  return (
    ...
    >
      ...
      {text ? (
        <p
          className={cn(
            "mt-4 text-center text-sm font-medium text-primary",
            textClassName,
          )}
        >
          {text}
...
export function LoadingOverlay({
  ...
  return (
    <div className={cn("relative", className)}>
      ...
      <div className="absolute inset-0 z-10 flex items-center justify-center bg-background/45 backdrop-blur-[1px]">
        <div className="rounded-lg border border-primary/20 bg-card/95 p-4 shadow-[0_0_32px_rgba(0,217,146,0.12)]">
...
export function LoadingCard({
  ...
  if (loading) {
    return (
      <div
        className={cn(
          "flex flex-col items-center justify-center rounded-lg border border-dashed border-primary/25 bg-background/80 p-8",
          className,
        )}
        {...props}
      >
