          ...
          {section.items.map((item, index) => {
            ...
            return (
              <article
                ...
                className={cn(
                  "rounded-lg border bg-card p-6 shadow-[0_0_15px_rgba(92,88,85,0.12)] transition-all duration-300 hover:border-primary/70",
              ...
              >
                ...
                <div className="mt-8 flex items-center gap-4">
                  {item.avatar ? (
                    ...
                    <div className="flex size-12 items-center justify-center rounded-full border bg-background font-medium text-primary">
