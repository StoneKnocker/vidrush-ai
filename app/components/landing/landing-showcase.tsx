...
function ShowcaseCard({
  ...
  return (
    <div className="rounded-lg border bg-card p-4 shadow-[0_0_15px_rgba(92,88,85,0.12)] transition-all duration-300 hover:border-primary/70 hover:shadow-[0_0_15px_rgba(0,217,146,0.14)]">
      ...
      <div className="mt-5">
        <h3 className="font-medium text-foreground text-xl">{item.title}</h3>
