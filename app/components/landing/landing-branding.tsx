      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {section.items.map((item) => (
            <div
              key={item.title}
              className="group hover:-translate-y-1 rounded-lg border border-[#3d3a39] bg-[#101010] p-6 shadow-[0_0_15px_rgba(92,88,85,0.16)] transition-all duration-300 hover:border-[#00d992]/70"
            >
              ...
              <p className="mt-5 font-medium text-[#f2f2f2] text-lg">
                {item.title}
              </p>
            </div>
          ))}
