      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className={cn("grid gap-5", desktopColumnsClass)}>
          {section.items.map((item, index) => (
            <article
              key={item.title}
              className="group hover:-translate-y-1 relative overflow-hidden rounded-lg border bg-card p-5 shadow-[0_0_15px_rgba(92,88,85,0.14)] transition-all duration-300 hover:border-primary/70"
            >
