      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="flex animate-fade-in flex-col items-center gap-12 lg:flex-row lg:items-center lg:gap-16">
          <div className="flex flex-col text-center lg:flex-1 lg:text-left">
            <h1 className="text-balance font-display font-normal text-5xl text-[#f2f2f2] leading-none tracking-[-0.02em] sm:text-6xl lg:text-7xl">
              <RichText text={section.title} />
            </h1>
            <div className="mt-6 max-w-2xl text-pretty text-[#b8b3b0] text-base leading-8 sm:text-lg">
