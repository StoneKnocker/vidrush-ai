...
--> statement-breakpoint
CREATE UNIQUE INDEX `billing_customer_user_provider_uidx` ON `billing_customer` (`userId`,`provider`);
--> statement-breakpoint
CREATE UNIQUE INDEX `billing_customer_provider_customer_uidx` ON `billing_customer` (`provider`,`providerCustomerId`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `subscription_publicId_unique` ON `subscription` (`publicId`);
--> statement-breakpoint
CREATE UNIQUE INDEX `subscription_provider_providerSubscriptionId_uidx` ON `subscription` (`provider`,`providerSubscriptionId`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `payment_publicId_unique` ON `payment` (`publicId`);
--> statement-breakpoint
CREATE UNIQUE INDEX `payment_provider_session_uidx` ON `payment` (`provider`,`providerSessionId`);
--> statement-breakpoint
CREATE UNIQUE INDEX `payment_provider_transaction_uidx` ON `payment` (`provider`,`providerTransactionId`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `credit_history_paymentId_idx` ON `credit_history` (`paymentId`);
--> statement-breakpoint
CREATE INDEX `credit_history_subscriptionId_idx` ON `credit_history` (`subscriptionId`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `user_sources_userId_idx` ON `user_source` (`userId`);
--> statement-breakpoint
